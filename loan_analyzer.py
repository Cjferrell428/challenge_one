...
print(loan.get("remaining_months"))  #should i add f strings? And if so what is the formatting there
...
present_value_of_loan = calculate_present_value(new_loan["future_value"], new_loan["remaining_months"], new_loan["annual_discount_rate"]) #Does this need f strings?
...
for price in loans:
    if price["loan_price"] < 500:
        #print(append(inexpensive_loans))
